...
function tasks(){
    document.getElementById("be_drawn").innerHTML="You have to draw- "+element;
utterThis= new SpeechSynthesisUtterance("You have to draw:"+element);
...
function clear_canvas(){
    ...
    document.getElementById("name_ob").innerHTML="Image you have drawn:";
    document.getElementById("accu").innerHTML="Confidence is:";
}
...
document.getElementById("name_ob").innerHTML= "Image you have drawn: "+label;
document.getElementById("accu").innerHTML="Confidence is: "+accuracy+" %";
}
